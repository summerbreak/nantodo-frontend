<template>
  <div class="task-card" :class="{ completed: isCompleted }">
    ...
    <div class="footer">
      <el-tooltip class="box-item" content="Chatgpt描述" placement="top-start" effect="light">
        <button @click="handleButtonClick('Button 1')">
          <i class="bi bi-robot"></i>
        </button>
      </el-tooltip>

      <el-tooltip class="box-item" content="写作业" placement="top-start" effect="light">
        <button @click="doHomework">
          <i class="bi bi-pencil-square"></i></button></el-tooltip>
      <el-tooltip class="box-item" content="完成" placement="top-start" effect="light">
        <button @click="completeTask">
          <i class="bi bi-check-lg"></i></button></el-tooltip>
    </div>
  </div>
